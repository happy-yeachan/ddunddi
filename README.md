...
칸 위쪽 점이 무엇이 있는지 알려준다 — 분홍은 일기, 파랑은 일정, 흐린 점은 끝낸 일정.
아래에는 남은 일정이 가까운 순으로 몇 개 보인다. 눌러서 그 날로 바로 간다.
같은 일정이 `우리` 화면의 "곧 찾아올 특별한 날"에도 기념일·생일과 함께 시간순으로 섞여 나온다.
...
**일기는 지난 날과 오늘에만 쓴다.** 아직 오지 않은 날에는 일기 칸 대신 안내가 뜬다.
일정은 앞날에도 잡을 수 있다.
